...
// String message = (">>MNGSA*b*016EFD2000026ED43000036EF73000046E114000056E034000066E2E4000076E144000086EEF3000096ED030000A6E0830000B6E3330000C6E1430000D6E363000*170325153449"); //here you can type in the text you want to send
String phone_nr = ("09161640761");                                   //recipient's phone number in international format
...
void convertString(String stringData){
  for (int i = 0; i< stringData.length(); i++)
  {
    GSMSerial.write(stringData[i]);
  }
}
