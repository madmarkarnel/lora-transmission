...
void setup()
{
  ...
  BTSerial.write("Press 'C' to go DEBUG mode!\r\n");
  ...
  while (serial_flag == 0)
  {
    if (BTSerial.available())
    {
      ...
      BTSerial.write("Entering debug mode!\r\n");
      serial_flag = 1;
    }
...
void loop()
{
  ...
  if (get_logger_version() == 8)
  {
    // BTSerial.write("Version 8!\r\n");
    // send_thru_lora("Test string . . .");
    read_batt_vol(1);
    send_thru_lora(voltMessage);  //kelangan naka attach ang rtc
    delay(1000);
  }
  else
  {
...
void send_thru_lora(char *radiopacket)
{
  ...
  BTSerial.write("Sending to LoRa: ");
  Serial.println((char *)payload);
  BTSerial.write((char *)payload);
  BTSerial.write("\r\n");
...
void read_lora_data_only()
{
  if (rf95.available())
  {
    BTSerial.write("waiting for LoRa data . . .\r\n");
